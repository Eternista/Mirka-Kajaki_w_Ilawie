            ...
            <div className='context'>
              ...
              <ul className="socials d-flex" aria-label="Social media links">
                <li
                  ...
                  aria-label="Tik Tok"
                  >
                    <a target="_blank" href="https://vm.tiktok.com/ZGecxn6jG/">
                ...
                <li
                  ...
                  aria-label="Facebook"
                  >
                    <a target="_blank" href="https://www.facebook.com/profile.php?id=100083264722815">
                ...
                <li
                  ...
                  aria-label="Youtube"
                  >
                    <a target="_blank" href="https://www.youtube.com/@mirosawasekowska-zzyciawyj4794">
